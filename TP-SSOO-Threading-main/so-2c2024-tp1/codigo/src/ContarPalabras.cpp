...
int main(int argc, char **argv) {
    ...
    // Completar
    auto promedio1 = hashMap.promedio();
    auto promedio2 = hashMap.promedioParalelo(cantThreadsMaximo);

    std::cout << promedio1 << std::endl;
    std::cout << promedio2 << std::endl;
    cargarMultiplesArchivos(hashMap, cantThreadsLectura, filePaths);
    promedio1 = hashMap.promedio();
    promedio2 = hashMap.promedioParalelo(cantThreadsMaximo);
